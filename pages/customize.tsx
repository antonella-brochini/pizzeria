...
import { clearCustomize } from "@/redux/slices/customizeSlice";
...
const Customize = () => {
  ...
  const handleFoodSwitch = (food_type: string) => {
    if (underCustomization) {
      // Compatible con Next/React modernos (sin librerías extra)
      const ok = window.confirm(
        `You are already customizing a ${currentFoodType}. Do you want to cancel the current process?`
      );
