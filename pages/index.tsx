      ...
      <div className="max-w-screen-xl px-2 mx-auto w-full">
        <div className="grid grid-cols-4 ">
          ...
          <div className="relative text-center  md:col-span-2 col-span-4">
            ...
            >
              <Link href="/menu">
                <div className=" focus:outline-none transition-all hover:shadow-btn_lg shadow-btn mt-4 px-4 py-2 font-bold rounded bg-primary text-white font-main uppercase">
                  order now
                </div>
              </Link>
            </motion.div>
