      ...
      <section className="min-h-screen sm:py-0 py-20 flex items-center">
        <div className="max-w-2xl px-2 w-full mx-auto">
          ...
          <div className="flex items-center sm:justify-between flex-wrap sm:space-y-0 justify-center sm:space-x-2">
            <Link href="/menu">
              <div className="font-main border-2 mb-2 border-primary text-primary  px-4 py-1 rounded ">
                back to menu
              </div>
            </Link>
            <Link href="/checkout/billing">
              <div className="font-main text-white bg-primary mb-2 border-2 border-primary px-4 py-1 rounded ">
                Billing details
              </div>
            </Link>
          </div>
